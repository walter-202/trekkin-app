    ...
    <View style={styles.container}>
      ...
      <View style={styles.roadmap}>
        ...
        <Text style={styles.roadmapItem}>
          HU-03 Explorar rutas → src/presentation/views/explore/
        </Text>
        <Text style={styles.roadmapItem}>
          HU-04 Offline → src/infrastructure/persistence/
        </Text>
        <Text style={styles.roadmapItem}>
          HU-06 Actividad GPS → src/presentation/views/activity/
        </Text>
        <Text style={styles.roadmapItem}>
          HU-07 Planificar nueva ruta → src/presentation/views/record/ ✓
          (activo)
        </Text>
        <Text style={styles.roadmapItem}>
