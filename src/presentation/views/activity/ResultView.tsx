...
export const ResultView: React.FC<ResultViewProps> = ({
  ...
  const handleUpdatePlannedRoute = async () => {
    ...
    try {
      ...
      const msg =
        err instanceof Error ? err.message : "Error al actualizar la ruta.";
    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      {saved.isSynced ? (
        ...
        <View style={styles.syncBanner}>
          <Text style={styles.syncText}>
            Guardado en el dispositivo. Se sincronizará en la nube
      ...
      <View style={styles.metricsCard}>
        ...
        <View style={styles.metricRow}>
          ...
          <Text style={styles.metricValue}>
            {calculateSpeedKmh(saved.distanceCoveredKm, saved.durationSeconds)}{" "}
            km/h
          </Text>
        </View>
        <View style={styles.metricRow}>
