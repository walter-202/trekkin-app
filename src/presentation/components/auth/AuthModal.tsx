...
export const AuthModal: React.FC<AuthModalProps> = ({
  ...
  const handleSubmit = async () => {
    ...
    if (mode === "register") {
      ...
      if (!acceptTerms) {
        setErrorMessage(
          "Debes aceptar los términos y las normas de seguridad en montaña.",
        );
        return;
      }
    ...
    >
      ...
      >
        <View style={styles.phoneContainer}>
          ...
          <View style={styles.header}>
            ...
            <View style={styles.centerPill}>
              ...
              <View style={styles.pillVersion}>
                <Text style={styles.pillVersionText}>PRO v1.0</Text>
              </View>
            </View>
          ...
          {/* High-Contrast White Elevated Sheet (DESIGN_RULES Image 1) */}
          <View style={styles.whiteSheet}>
            ...
            >
              ...
              {/* Form fields in exact order (DESIGN_RULES Section 3.A) */}
              {/* 1. Nombre Completo */}
              {mode === "register" && (
              ...
              {/* 7. Botón CTA CREAR CUENTA → en esmeralda profundo (#064e3b) */}
              <Pressable
...
const styles = StyleSheet.create({
  ...
  inputContainer: {
    flexDirection: "row",
    alignItems: "center",
    backgroundColor: "#f8faf9", // Canvas Soft Tint
    borderWidth: 1,
    borderColor: "#e2e8f0",
    borderRadius: 14,
    height: 46,
  ...
  ctaButton: {
    backgroundColor: "#064e3b", // Deep Emerald CTA
    height: 48,
    borderRadius: 14,
    flexDirection: "row",
    alignItems: "center",
